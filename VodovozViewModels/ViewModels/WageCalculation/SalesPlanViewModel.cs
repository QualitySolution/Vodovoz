...
namespace Vodovoz.ViewModels.WageCalculation
{
	public class SalesPlanViewModel : EntityTabViewModelBase<SalesPlan>
	{
		...
		private readonly IEntityAutocompleteSelectorFactory _equipmentKindSelectorFactory;
		...
		public SalesPlanViewModel(IEntityUoWBuilder uoWBuilder, IUnitOfWorkFactory unitOfWorkFactory, ICommonServices commonServices, INomenclatureSelectorFactory nomenclatureSelectorFactory/*, IEntityAutocompleteSelectorFactory equipmentKindSelectorFactory*/) : base(uoWBuilder, unitOfWorkFactory, commonServices)
		{
			_nomenclatureSelectorFactory = nomenclatureSelectorFactory ?? throw new ArgumentNullException(nameof(nomenclatureSelectorFactory));
			//_equipmentKindSelectorFactory = equipmentKindSelectorFactory ?? throw new ArgumentNullException(nameof(equipmentKindSelectorFactory));
